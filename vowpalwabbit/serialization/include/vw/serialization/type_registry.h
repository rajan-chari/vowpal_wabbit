...
namespace typesys
{
  ...
  public:
    ...
    {
      return register_type_internal(name, etype);
    }
  ...
  private:
    type_descriptor& register_type_internal(const name_t name, erased_type etype)
    {
      ...
      // it uint32_t
      type_number typeindex = static_cast<typesys::type_number>(_types.size()); 
